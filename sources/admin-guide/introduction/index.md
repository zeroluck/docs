...
Authenticating people online, and controlling access to API's can be
challenging, but if you have the right recipe it is an attainable
objective.

In the sections listed below you will find some high level information
about the who, what, where, when, and why of the Gluu Server.

Community Support can be found and requested on our [public knowledge
base](http://support.gluu.org), while [VIP
Support](http://gluu.org/pricing) can be purchased for private
assistance, priority responses, and help with the code.

# Our Mission

Gluu's mission is to help organizations all over the world to enforce
application security with easy, free, flexible and scalable open source
software.
...
Communication](https://raw.githubusercontent.com/GluuFederation/docs/master/sources/img/design/gluu_http-tomcat_overview.png=250x)
