...
Commercial Gluu Server Cluster Packages are currently under development but not quite ready for primetime. You can learn more about the cluster project [here](http://gluu.org/docs-cluster). 
