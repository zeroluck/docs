...
## Memory
- Does the system have enough memory/CPU? For a production deployment, at least 4GB of RAM is required for for tomcat and the full amount of RAM assigned for the host should be no less than 6GB. 
