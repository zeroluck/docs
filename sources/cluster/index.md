...
Please follow steps provided in next articles to install csync2 on both nodes: [Ubuntu 14.x](./csync-installation.md), [CentOS 6.x](./csync-installation.md), [CentOS 7.x](./csync-installation.md).
